<!-- https://icon-sets.iconify.design/material-symbols/keyboard-double-arrow-down-rounded/ -->
<template>
  <svg fill="currentColor" stroke="none" viewBox="4.5 4.75 15 15" xmlns="http://www.w3.org/2000/svg">
